...
#[Route('/member/universe')]
class UniverseController extends AbstractController
{
    #[Route('/', name: 'app_universe')]
    public function index(EntityManagerInterface $entityManager): Response
    {  

        return $this->render('universe/2d/index.html.twig', [
            'controller_name' => 'UniverseController',
        ]);
    }

    #[Route('/room/{roomId}', name: 'app_universe_room', methods: ['GET'])]
    ...
    #[Route('/room/{roomId}/message', name: 'app_universe_message', methods: ['POST'])]
    ...
    #[Route('/room/{roomId}/player', name: 'app_universe_player', methods: ['POST'])]
